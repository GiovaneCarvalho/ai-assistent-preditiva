...
*   **LangGraph em vez de LCEL simples**: Embora cadeias lineares (LCEL) sejam mais fáceis de construir, o `LangGraph` oferece um controle refinado sobre o roteamento cíclico e a passagem de estado (state-passing). O padrão Supervisor -> Especialista é resolvido de forma nativa e expansível.
